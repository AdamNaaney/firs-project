...
function Home() {
  return (
    ...
    <div>
      <Header/>
    <div className="min-h-screen bg- bg-gradient-to-r from-primaryColor to-secondaryColor text-white">
    
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          <h2 className="text-5xl font-extrabold pt-14 mb-6">Welcome to NoteMaster</h2>
          <p className="text-xl mb-8">Your personal note-taking companion, wherever you go.</p>
          <button className="bg-white text-primaryColor font-bold py-3 px-6 rounded-md shadow-lg hover:bg-gray-100 transition-colors">
            Get Started
          </button>
        </div>
           </div>
      ...
      {/* <div id="features" className="py-16 bg-white text-primaryColor">
      ...
      <div className="py-6 mt-[130px] bg-primaryColor text-center">
