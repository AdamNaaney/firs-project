...
<Header/>
    ...
    <div className="min-h-screen  bg-gradient-to-r from-primaryColor to-secondaryColor flex items-center justify-center p-6">
      <form 
      ...
      >
        ...
        <button onClick={UpdateNote}
          type="submit"
          className="w-full bg-primaryColor text-white font-bold py-3 px-4 rounded-md hover:from-teal-600 hover:bg-secondaryColor transition-colors"
        >
          Save Note
        </button>
      </form>
