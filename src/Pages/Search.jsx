    ...
    return (
        <div className="min-h-screen bg-teal-50">
            ...
            <div className="container mx-auto py-8 px-4">
                <h1 className="text-3xl font-bold text-center mb-8 text-secondaryColor">Search Notes</h1>
                ...
                <div className="flex justify-center mb-6">
                    <form className="flex flex-col items-center w-full sm:w-[500px] mx-auto">
                        ...
                        <button 
                            onClick={getNote} 
                            className={`w-full py-3 text-white rounded-lg transition-colors ${loading ? 'bg-teal-400' : 'bg-secondaryColor hover:bg-primaryColor'}`}
                            disabled={loading}
                        >
